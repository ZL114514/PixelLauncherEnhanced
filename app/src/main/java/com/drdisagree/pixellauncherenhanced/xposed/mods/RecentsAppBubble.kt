    ...
    override fun handleLoadPackage(loadPackageParam: LoadPackageParam) {
        ...
        appInfoShortcutClass
            ...
            .runBefore { param ->
                ...
                try {
                    param.thisObject.setField("mLabel", bubbleLabel)
                } catch (throwable: Throwable) {
                    log(this@RecentsAppBubble, "setIconAndLabelFor: unable to set mLabel: ${throwable.message}")
                }
                param.result = null
            }
        ...
        appInfoShortcutClass
            ...
            .runBefore { param ->
                ...
                try {
                    ...
                    log(this@RecentsAppBubble, "setIconAndContentDescriptionFor: unable to set mLabel: ${throwable.message}")
                }
    ...
    private fun handlePopupProxyMethod(
        ...
        when (methodName) {
            ...
            "setIconAndLabelFor" -> {
                ...
                labelView.text = bubbleLabel
                try {
                    shortcut.setField("mLabel", bubbleLabel)
                } catch (throwable: Throwable) {
                    log(this, "popup setIconAndLabelFor: unable to set mLabel: ${throwable.message}")
                }
                return null
            }
